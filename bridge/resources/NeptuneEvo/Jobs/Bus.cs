...
namespace NeptuneEvo.Jobs
{
    class Bus : Script
    {
        ...
        private static Dictionary<string, Vector3> BusStations = new Dictionary<string, Vector3>()
        {
            ...
            { "Автозаправочная Станция", new Vector3(602.8403, -3018.18, 6.131153) },
            { "Ист сайд", new Vector3(837.6479, -1807.675, 29.10327) },
            { "Коллекторы", new Vector3(807.4769, -1195.802, 27.39124) },
            { "Механики", new Vector3(449.7962, -1249.931, 30.22602) },
            { "Чумаш", new Vector3(-3104.435, 1097.097, 20.59407) },
            { "Палметто Бэй", new Vector3(-151.3444, 6211.825, 31.31864) },
            { "Песчаный берег", new Vector3(1856.94, 3669.111, 34.11074) },
        };
        #endregion
