...
namespace NeptuneEvo.Fractions
{
    ...
    { // Revision 3.0
        ...
        public static void onResourceStart()
        {
            try
            {
                NAPI.Blip.CreateBlip(589, Merryweather.Coords[0], 1.3f, 75, Main.StringToU16("Безопасности Фрейя"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(494, Manager.FractionSpawns[16], 1, 20, Main.StringToU16("Потерянные"), 255, 0, true, 0, 0);
                ...
                NAPI.Blip.CreateBlip(61, Ems.emsCheckpoints[0], 1, 49, Main.StringToU16("Больница"), 255, 0, true, 0, 0);
                ...
                NAPI.Blip.CreateBlip(84, Manager.FractionSpawns[1], 1, 52, Main.StringToU16("Семья"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(84, Manager.FractionSpawns[2], 1, 58, Main.StringToU16("Баллас"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(84, Manager.FractionSpawns[3], 1, 28, Main.StringToU16("Вагос"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(84, Manager.FractionSpawns[4], 1, 74, Main.StringToU16("Марабунта Гранде"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(84, Manager.FractionSpawns[5], 1, 49, Main.StringToU16("Кровавая улица"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[10], 1, 5, Main.StringToU16("Коза Ностра"), 255, 0, true, 0, 0);
    ...
    class Stocks : Script
    {
        ...
        private static Dictionary<int, Vector3> garageCoords = new Dictionary<int, Vector3>()
        {
            ...
            { 17, new Vector3(1551.65, 2152.611, 77.78671)}, // TODO:
        };
